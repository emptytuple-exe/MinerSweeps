...
def mega():
    ...
    label2=Label(frame1,text="Game Over",bg="red",fg='black',font=("Courier",45))
    ...
    button2.grid(column=1, row=2, columnspan=2, padx=10,pady=10)
...
def mini():
    ...
    label3=Label(frame2,text="You have found all the mines!",bg="green",fg='black',font=("Courier",35))
    ...
    button4.grid(column=1, row=2, columnspan=2, padx=10,pady=10)
